...
#define GPIO_IR_EINT_PIN               (GPIO150 | 0x80000000)
#define GPIO_REMOTEIR_RESET_PIN     (GPIO151 | 0x80000000)
#define GPIO_VDDIR_EN               (GPIO149 | 0x80000000)
...
#define IRDA_DEVICE "remote_ctrl"


static const struct i2c_device_id bl_id[] = { {IRDA_DEVICE, 0}, {} };
static struct i2c_board_info __initdata remote_ctrl_i2c_info = { I2C_BOARD_INFO(IRDA_DEVICE, 0x50) };
...
static const struct i2c_device_id RC_ID[] ={{IRDA_DEVICE,0}, {} };
#ifdef CONFIG_OF
static const struct of_device_id remote_ctrl_of_ids[] = {
    { .compatible = "mediatek,remote_ctrl", },
    {}
};
#endif
struct i2c_driver rc_i2c_driver =
{
    .driver = {
        .name   = IRDA_DEVICE,
        .owner = THIS_MODULE,
 #ifdef CONFIG_OF
     .of_match_table = remote_ctrl_of_ids,
 #endif
...
#ifdef CONFIG_OF
static const struct of_device_id remoteplatformdev_of_ids[] = {
    { .compatible = "mediatek,remoteplatformdev", },
    {}
};
#endif
...
static struct platform_driver remote_platform_driver = {
	...
	.driver = {
		   ...
		   .owner = THIS_MODULE,
#ifdef CONFIG_OF
           .of_match_table = remoteplatformdev_of_ids,
#endif
