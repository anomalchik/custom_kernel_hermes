...
u32 pinSet[3][8] = {
	...
	if (On) {
		...
		if ((currSensorName && (0 == strcmp(currSensorName,SENSOR_DRVNAME_OV5670_MIPI_RAW)))|| (currSensorName && (0 == strcmp(currSensorName,SENSOR_DRVNAME_OV5670_2ND_MIPI_RAW)))){
			if(TRUE != hwPowerOn(CAMERA_POWER_VCAM_A, VOL_2800,mode_name))
			{
		...
		}else if(currSensorName && (0 == strcmp(SENSOR_DRVNAME_S5K3M2_MIPI_RAW, currSensorName)) || (0 == strcmp(SENSOR_DRVNAME_S5K3M2_2ND_MIPI_RAW, currSensorName)) || (0 == strcmp(SENSOR_DRVNAME_OV13850_MIPI_RAW, currSensorName))){
...
//__empty_name			
		...
		if ((currSensorName && (0 == strcmp(currSensorName,SENSOR_DRVNAME_IMX135_MIPI_RAW)))||(currSensorName && (0 == strcmp(currSensorName,SENSOR_DRVNAME_IMX220_MIPI_RAW)))||(currSensorName && (0 == strcmp(currSensorName,SENSOR_DRVNAME_IMX214_MIPI_RAW)))){
		...
		if (currSensorName && (0 == strcmp(currSensorName,SENSOR_DRVNAME_OV16825_MIPI_RAW))){
			if(mt_set_gpio_mode(pinSet[pinSetIdx][IDX_PS_CMPDN],pinSet[pinSetIdx][IDX_PS_CMPDN+IDX_PS_MODE])){PK_DBG("[CAMERA LENS] set gpio mode failed!!\n");}
			if(mt_set_gpio_dir(pinSet[pinSetIdx][IDX_PS_CMPDN],GPIO_DIR_OUT)){PK_DBG("[CAMERA LENS] set gpio dir failed!!\n");}
		...
		if ((currSensorName && (0 == strcmp(currSensorName,SENSOR_DRVNAME_OV5670_MIPI_RAW)))||(currSensorName && (0 == strcmp(currSensorName,SENSOR_DRVNAME_OV5670_2ND_MIPI_RAW)))){		
			...
			}else if((currSensorName && (0 == strcmp(currSensorName,SENSOR_DRVNAME_S5K3M2_MIPI_RAW)))||(currSensorName && (0 == strcmp(currSensorName,SENSOR_DRVNAME_S5K3M2_2ND_MIPI_RAW)))||(currSensorName && (0 == strcmp(currSensorName,SENSOR_DRVNAME_OV13850_MIPI_RAW)))){
				if(mt_set_gpio_mode(pinSet[pinSetIdx][IDX_PS_CMRST],pinSet[pinSetIdx][IDX_PS_CMRST+IDX_PS_MODE])){PK_DBG("[CAMERA SENSOR] set gpio mode failed!! (CMRST)\n");}
				if(mt_set_gpio_dir(pinSet[pinSetIdx][IDX_PS_CMRST],GPIO_DIR_OUT)){PK_DBG("[CAMERA SENSOR] set gpio dir failed!! (CMRST)\n");}
				if(mt_set_gpio_out(pinSet[pinSetIdx][IDX_PS_CMRST],pinSet[pinSetIdx][IDX_PS_CMRST+IDX_PS_OFF])){PK_DBG("[CAMERA SENSOR] set gpio failed!! (CMRST)\n");}
