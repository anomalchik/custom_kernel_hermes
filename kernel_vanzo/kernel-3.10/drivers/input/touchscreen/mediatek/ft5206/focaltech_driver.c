...
static const struct i2c_device_id ft5206_tpd_id[] = {{"FT",0},{}};
static struct i2c_board_info __initdata ft5206_i2c_tpd={ I2C_BOARD_INFO("FT", (0x70>>1))};
...
{	 
	...
	TPD_DMESG("tpd_probe: %d, data:%d\n", i2c_smbus_read_i2c_block_data(i2c_client, 0x00, 1, &data), data);
